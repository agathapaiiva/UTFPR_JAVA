		...
		try {
			...
			do {
				...
				case 5:
					...
					bdveiculos.placa = entradaDado.next();
					bdveiculos.pesquisaPlacaPasseio(bdveiculos.placa);
					System.out.println("================================================================");
					break;
				case 6: 
					System.out.println("================================================================");
					...
					bdveiculos.placa = entradaDado.next();
					bdveiculos.pesquisaPlacaCarga(bdveiculos.placa);
					System.out.println("================================================================");
					break;
				case 7: 
					System.out.println("================================================================");
					...
					bdveiculos.placa = entradaDado.next();
					bdveiculos.excluirVeiculosPasseioPelaPlaca(bdveiculos.placa);
					System.out.println("================================================================");
					break;
				case 8:
					System.out.println("================================================================");
					...
					System.out.println("Digite a placa do veículo: ");
					bdveiculos.placa = entradaDado.next();
					bdveiculos.excluirVeiculosCargaPelaPlaca(bdveiculos.placa);
					System.out.println("================================================================");
					break;
